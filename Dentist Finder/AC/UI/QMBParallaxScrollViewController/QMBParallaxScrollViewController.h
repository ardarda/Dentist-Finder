...
@optional
/**
 * Calls when the action bar should show
 */
- (void)parallaxScrollViewController:(QMBParallaxScrollViewController *) controller shouldShowActionBar:(BOOL)show;

/**
 * Calls when the status bar cover should show
 */
- (void)parallaxScrollViewController:(QMBParallaxScrollViewController *) controller shouldShowStatusBarCover:(BOOL)show;
